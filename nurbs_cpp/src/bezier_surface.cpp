...
namespace nurbs {
    BezierSurface::BezierSurface(std::vector<BezierCurve3D> curves, glm::dvec2 u_interval,
        glm::dvec2 v_interval) : Surface(u_interval, v_interval), curves_(curves) {}


    glm::dvec3 BezierSurface::EvaluatePoint(glm::dvec2 uv) const {
    ...
    std::vector<glm::dvec3> BezierSurface::EvaluatePoints(
