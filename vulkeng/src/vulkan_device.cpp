...
namespace vulkeng {
static constexpr bool PRINT_DEBUG_INFO = 0;
...
void VulkanDevice::CreateSurface() {
    window_->CreateWindowSurface(vk_instance_, &surface_);
}
...
void VulkanDevice::SetupDebugMessenger() {
    ...
    if (CreateDebugUtilsMessengerEXT(vk_instance_, &create_info, nullptr,
