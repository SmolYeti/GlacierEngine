...
namespace vulkeng {
void VulkanCamera::SetOrthographicProjection(float left, float right, float top,
                                             float bottom, float near,
                                             float far) {
  projection_matrix_ = glm::mat4(1.f);
...
void VulkanCamera::SetPerspectiveProjection(float fovy, float aspect,
...
void VulkanCamera::SetViewDirection(glm::vec3 position, glm::vec3 direction,
                                    glm::vec3 up) {
