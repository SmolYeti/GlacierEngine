...
const std::string VERTEX_PATH =
    "C:/Users/WJSSn/Documents/GitRepos/VulkanGrowProject/shaders/perlin_vert.spv";
const std::string FRAGMENT_PATH =
    "C:/Users/WJSSn/Documents/GitRepos/VulkanGrowProject/shaders/perlin_frag.spv";
...
PerlinNoiseRenderSystem::PerlinNoiseRenderSystem(
...
void PerlinNoiseRenderSystem::CreatePipelineLayout(
    VkDescriptorSetLayout global_set_layout) {
...
void PerlinNoiseRenderSystem::CreatePipeline(VkRenderPass render_pass) {
...
void PerlinNoiseRenderSystem::Update(const FrameInfo& frame_info,
                                     GlobalUbo& ubo) {
  offset_ += (frame_info.frame_time / 10.0f);
  ubo.offset = offset_;
}

void PerlinNoiseRenderSystem::Render(const FrameInfo& frame_info) {
